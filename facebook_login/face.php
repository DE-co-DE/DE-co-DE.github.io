...
class Face
{
	...
	public $redirect_uri       = 'http://localhost/login.html';  
	public $app_id             = '2037374113171707';
	public $app_secret		   = 'd7b71201000ff3397214c6bda9715c3b'; 
	...
	{
		$url = $this->auth_url . 'client_id=' .$this->app_id. '&redirect_uri=' .$this->redirect_uri. '&scope=email';
		if($mode === TRUE)
		{
			header('Location: '.$url);
		}
